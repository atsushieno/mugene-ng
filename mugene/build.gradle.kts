buildscript {
    ...
    dependencies {
        classpath("com.strumenta.antlr-kotlin:antlr-kotlin-gradle-plugin:0.0.8")
    }
}
    ...
    sourceSets {
        val commonAntlr by creating {
            dependencies {
                ...
                api("com.strumenta.antlr-kotlin:antlr-kotlin-runtime:0.0.8")
            }
            kotlin.srcDir("build/generated-src/commonAntlr/kotlin")
        }
        val commonMain by getting {
            dependencies {
                implementation("dev.atsushieno:ktmidi-kotlinMultiplatform:0.1.3")
            }
        ...
        val jvmMain by getting {
            dependencies {
                implementation("dev.atsushieno:ktmidi-jvm:0.1.3")
            }
        }
        ...
        val jsMain by getting {
            dependencies {
                implementation("dev.atsushieno:ktmidi-js:0.1.3")
            }
        }
...
/*
        val nativeMain by getting {
            dependencies {
                implementation("dev.atsushieno:ktmidi-native:0.1.3")
            }
        }
...
tasks.register<com.strumenta.antlrkotlin.gradleplugin.AntlrKotlinTask>("generateKotlinCommonGrammarSource") {
    ...
    antlrClasspath = configurations.detachedConfiguration(
        ...
        project.dependencies.create("com.strumenta.antlr-kotlin:antlr-kotlin-target:0.0.8")
    )
    maxHeapSize = "64m"
